<html>
    <body style="font-family:sans-serif;">
        <header style="background-color:white">
            <a href="https://geographyofrussia.com/mirovoj-okean/" style="color:navy">Стаття про океан</a>
        </header>
        <main style="background-color:lightblue">
            ...
            <p style="opacity:0.3"> <img src="/uploads/2020/10/water-3194377_1920_0_1603951480.jpg" width="850px"/></p>
        </main>
